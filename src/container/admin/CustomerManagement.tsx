...
// Local type for Ganpati row display
...
export default function BookingManagement() {
  ...
  // Unified receipt sending function
              ...
              {viewBooking && (
                <Box>
                  ...
                  <Box display="flex" gap={2} flexWrap="wrap">
                    <Button variant="contained" startIcon={<SendIcon />} onClick={() => { const booking = bookings.find((b) => b.id === viewBooking.id); if (booking) handleSendReceipt(booking); }} sx={{ bgcolor: '#25D366', '&:hover': { bgcolor: '#128C7E' }, borderRadius: 3, px: 3, flex: { xs: '1 1 100%', sm: 'none' } }}>{t('booking.send_receipt')}</Button>
